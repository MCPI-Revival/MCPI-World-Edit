...
def getPos1():
    ...
    pos1x, pos1y, pos1z = mc.player.getTilePos()
...
def setblock_query():
    ...
    #If cube or hollow cube or wall or center
    if func == 1 or func == 2 or func == 5 or func == 6:
        try:
        ...
        if func == 1:
            ...
            center(data, blockID, pos1x, pos2x, pos1y, pos2y, pos1z, pos2z)
